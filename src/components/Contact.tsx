...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 px-4 bg-gray-800 relative">
      <div className="max-w-6xl mx-auto relative z-10">
        <h2 className="text-4xl font-bold text-white text-center mb-4 animate-fade-in">Get In Touch</h2>
          ...
          <div className="animate-fade-in opacity-0 [animation-delay:0.4s] [animation-fill-mode:forwards]">
            ...
            <div className="space-y-6">
              {contactMethods.map((method, index) => (
                <Card 
                  key={index} 
                  className={`bg-gray-900 border-gray-700 transition-all duration-300 hover:scale-105 hover:shadow-xl ${getHoverColors(method.color)} group`}
                >
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-white font-semibold group-hover:text-gray-100 transition-colors duration-300">{method.title}</h4>
                        <p className="text-gray-400 text-sm mb-2 group-hover:text-gray-300 transition-colors duration-300">{method.description}</p>
                        <a 
                          href={method.href}
                          target="_blank"
            ...
            <div className="mt-8 p-6 bg-gray-900 rounded-lg border border-gray-700 hover:border-red-500/50 hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300 hover:scale-105 group">
              <div className="flex items-center gap-3 mb-4">
                <MapPin className="h-6 w-6 text-red-400 group-hover:scale-110 transition-transform duration-300" />
                <h4 className="text-white font-semibold group-hover:text-gray-100 transition-colors duration-300">Location</h4>
              </div>
              <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">Sétif, Algeria</p>
              <p className="text-gray-400 text-sm mt-1 group-hover:text-gray-300 transition-colors duration-300">Available for remote work worldwide</p>
            </div>
          </div>
          
          {/* Contact Form */}
          <div className="animate-fade-in opacity-0 [animation-delay:0.6s] [animation-fill-mode:forwards]">
            <Card className="bg-gray-900 border-gray-700 hover:border-gray-600 transition-all duration-300 hover:shadow-xl">
              <CardHeader>
                ...
                <form className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input 
                        id="firstName" 
                        placeholder="John"
                        className="bg-gray-800 border-gray-600 text-white placeholder:text-gray-400 focus:border-blue-500 transition-all duration-300"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full p-3 bg-gray-800 border border-gray-600 rounded-md text-white placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300"
                    />
                  </div>
